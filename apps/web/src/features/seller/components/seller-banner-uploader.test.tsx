...
describe("SellerBannerUploader", () => {
  ...
  it("uploads the selected file and returns its public media URL", async () => {
    uploadAsync.mockResolvedValue({
      file: {
        objectInfo: {
          key: "sellers/seller_123/banner/banner.png",
        },
      },
    });
    ...
    expect(onBannerChange).toHaveBeenCalledWith({
      name: "banner.png",
      url: "https://example.supabase.co/storage/v1/object/public/public-media/sellers/seller_123/banner/banner.png",
    });
  });
});
