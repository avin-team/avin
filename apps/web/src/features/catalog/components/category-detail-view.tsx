  ...
  if (isError) {
    return (
      <div className="rounded-2xl border border-destructive/20 bg-destructive/5 p-8 text-center">
        ...
        <Button className="mt-4" onClick={onRefetch} size="sm" type="button">
          Tải lại
        </Button>
      </div>
    );
        ...
        <aside className="space-y-6 lg:col-span-1">
          ...
          <div className="rounded-2xl border border-border/60 bg-card/60 p-5 shadow-xs backdrop-blur-md space-y-4">
            <div className="flex items-center justify-between border-b border-border/40 pb-3">
              ...
              {selectedSubSlug && (
                <Button
                  className="h-auto p-0 text-[11px] text-muted-foreground hover:text-primary hover:bg-transparent"
                  onClick={() => onSubSelect()}
                  type="button"
                  variant="ghost"
                >
            ...
            <div className="space-y-1">
              <Button
                className="w-full justify-between rounded-xl px-3 py-2 text-xs font-medium"
                onClick={() => onSubSelect()}
                size="sm"
                type="button"
                variant={selectedSubSlug ? "ghost" : "default"}
              >
